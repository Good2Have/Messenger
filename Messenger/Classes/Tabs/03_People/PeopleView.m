...
//-------------------------------------------------------------------------------------------------------------------------------------------------
{
	...
	//---------------------------------------------------------------------------------------------------------------------------------------------
	NSString *format = @"isDeleted == NO AND (fullname CONTAINS[c] %@ OR numbers CONTAINS[c] %@ OR emails CONTAINS[c] %@)";
	NSPredicate *predicate = [NSPredicate predicateWithFormat:format, text, text, text];
